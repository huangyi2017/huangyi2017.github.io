...
<button onclick="alert(document.getElementById('cache16').value=='volatile-lru,volatile-lfu,volatile-random,volatile-ttl,allkeys-lru,allkeys-lfu,allkeys-random,noeviction'?'正确':'错误')">submit</button>
